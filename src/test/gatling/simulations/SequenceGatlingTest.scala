...
class SequenceGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Sequence entity")
        ...
        .repeat(2) {
            ...
            .post("/api/sequences")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "code":"SAMPLE_TEXT", "libelleFr":"SAMPLE_TEXT", "libelleEn":"SAMPLE_TEXT", "anneeScolaire":"SAMPLE_TEXT", "dateDeb":"2020-01-01T00:00:00.000Z", "dateFin":"2020-01-01T00:00:00.000Z", "isActive":null}""")).asJSON
            .check(status.is(201))
