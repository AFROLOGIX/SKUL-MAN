(function() {
    ...
    angular
        .module('skulmanApp')
        .factory('PeriodeSaisieNote', PeriodeSaisieNote);

    PeriodeSaisieNote.$inject = ['$resource', 'DateUtils'];

    function PeriodeSaisieNote ($resource, DateUtils) {
        var resourceUrl =  'api/periode-saisie-notes/:id';
