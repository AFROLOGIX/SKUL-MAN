...
@Document(indexName = "fonctionnalite")
public class Fonctionnalite implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        Fonctionnalite fonctionnalite = (Fonctionnalite) o;
        if(fonctionnalite.id == null || id == null) {
            return false;
        }
        return Objects.equals(id, fonctionnalite.id);
    }
